...
{
    [Serializable, VolumeComponentMenu("Custom/Distortion")]
    public sealed class Distortion : VolumeComponent, IPostProcessComponent
    {
        ...
        /// </summary>
        [Tooltip("The magnitude in texels of distortion fx.")]
        public MinFloatParameter Magnitude = new MinFloatParameter(1.0f, 0);
        ...
        /// </summary>
        [Tooltip("The down-scale factor to apply to the generated texture.")]
        public MinIntParameter DownScaleFactor = new MinIntParameter(0, 0);
        ...
        public BoolParameter DebugView = new BoolParameter(false);
